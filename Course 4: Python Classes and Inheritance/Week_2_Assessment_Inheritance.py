...
# 3
# A method in the parent class that will be inherited by the
# subclasses is written. The method is called opponent and returns
# the type of pokemon the current type is weak and strong against as
# a tuple.
...
# The following example helps to understand: if the p_type
# of the subclass is 'Grass', the .opponent() method should return
...
class Pokemon():
    ...
    def __str__(self):
        self.update()
        return "Pokemon name: {}, Type: {}, Level: {}".format(self.name,
                                                              self.p_type,
                                                              self.level)
